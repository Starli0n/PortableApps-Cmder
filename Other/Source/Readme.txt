DEVELOPER: Replace the three occurrences of CmderPortable in this file
...
user in an INI file next to CmderPortable.exe called CmderPortable.ini.
...
copy AppNamePortable.ini from this directory to CmderPortable.ini next to
CmderPortable.exe. The options in the INI file are as follows:
